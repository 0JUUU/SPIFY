<template>
    <div id="app">
        <div class="map_wrap">
            ...
            <div id="matviewControl" @click="setMatviewRoad()"></div>
            <div id="aptviewControl" @click="setAptviewRoad()"></div>
        
            <div id="menu_wrap" class="bg_white">
                <div class="option">
                    <div>
                        <form @click="searchPlaces(); return false;">
                            키워드 : <input type="text" v-model="this.keyword" id="keyword" size="15"> 
...
export default {
    ...
    methods: {
        ...
        // 키워드 검색을 요청하는 함수입니다
        searchPlaces() {
            this.keyword = JSON.parse(localStorage.getItem("vuex")).dong.value + ' 맛집';
